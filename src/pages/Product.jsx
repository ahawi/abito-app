        ...
        <div className="section__body">
          <div className="page">
            <div className="page__body">
              <h1 className="page__body-title">{findProduct.title}</h1>
              <img
                src={findProduct.image}
                alt={findProduct.title}
                className="page__body-img"
                width="460"
                height="357"
                loading="lazy"
              />
              <p className="page__body-description">
                {findProduct.description}
              </p>
            </div>

            <div className="page__right">
              <p className="page__right-price">{findProduct.price} ₽</p>
              <button type="button" className="page__right-button button">
                Показать телефон
              </button>
            </div>
          </div>
